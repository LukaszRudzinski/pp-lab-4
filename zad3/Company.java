public static void main(String[] args) {
    ...
    // Count the number of employees who are not managers
    ...
    // Set the counted value as the new numberOfSubordinates for the manager at index 0
    ((Manager) employees[0]).setNumberOfSubordinates(numberOfNonManagers);

    // Set the salary for the manager at index 0
